...
public interface IRecycle3
{
    void Restart();
    void ShutDown();
}

public class RecycleGameObjectGalaxy : MonoBehaviour
{
    private List<IRecycle3> recycleComponents;
    /*
    ...
    */
    ...
    private void Awake()
    {
        ...
        recycleComponents = new List<IRecycle3>();

        foreach (var component in components)
        {
            if (component is IRecycle3)
            {
                recycleComponents.Add(component as IRecycle3);
            }
